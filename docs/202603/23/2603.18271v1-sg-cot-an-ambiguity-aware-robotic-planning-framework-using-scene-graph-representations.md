...
method: 采用两阶段框架，先构建包含物体属性与关系的场景图，再利用检索函数引导LLM迭代查询场景图以实现推理接地与歧义消除。
result: "实验显示SG-CoT在提问准确率上提升至少10%，且在单智能体和多智能体环境下的任务成功率分别提高了4%和15%。"
conclusion: 通过将场景图与思维链结合，SG-CoT增强了机器人的感知接地能力，为解决复杂环境下的歧义规划问题提供了有效途径。
---
