...
title_zh: 具身科学：利用代理式具身人工智能闭合发现环路
...
## 摘要
人工智能在预测科学属性方面已展现出卓越的能力，然而科学发现本质上是一个受实验周期支配的、物理性的、长程的探索过程。目前大多数计算方法与这一现实并不匹配，它们将发现视为孤立的、针对特定任务的预测，而非与物理世界的持续交互。在本文中，我们倡导“具身科学”（embodied science），这一范式将科学发现重新定义为将智能体推理与物理执行紧密耦合的闭环。我们提出了一个统一的“感知-语言-动作-发现”（PLAD）框架，在该框架中，具身智能体感知实验环境，基于科学知识进行推理，执行物理干预，并内化实验结果以驱动后续探索。通过将计算推理建立在稳健的物理反馈基础上，该方法弥合了数字预测与实证验证之间的鸿沟，为生命科学和化学领域的自主发现系统提供了路线图。
